...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Mo(e,t,n){let r=new Float32Array(vo),i=new q(0,1,0);return new Vi({name:`SphericalGaussianBlur`,defines:{n:vo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Fo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function No(){return new Vi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Fo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Po(){return new Vi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Fo(),fragmentShader:`
	...
	`}var Io=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ei(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`),r=[];for(let e=0,i=n.length;e<i;e++){let i=n[e].trimStart();if(i.length===0)continue;let a=i.charAt(0);if(a!==`#`)if(a===`v`){let e=i.split(Yl);switch(e[0]){case`v`:t.vertices.push(parseFloat(e[1]),parseFloat(e[2]),parseFloat(e[3])),e.length>=7?(tu.setRGB(parseFloat(e[4]),parseFloat(e[5]),parseFloat(e[6]),Ie),t.colors.push(tu.r,tu.g,tu.b)):t.colors.push(void 0,void 0,void 0);break;case`vn`:t.normals.push(parseFloat(e[1]),parseFloat(e[2]),parseFloat(e[3]));break;case`vt`:t.uvs.push(parseFloat(e[1]),parseFloat(e[2]));break}}else if(a===`f`){let e=i.slice(1).trim().split(Yl),n=[];for(let t=0,r=e.length;t<r;t++){let r=e[t];if(r.length>0){let e=r.split(`/`);n.push(e)}}let r=n[0];for(let e=1,i=n.length-1;e<i;e++){let i=n[e],a=n[e+1];t.addFace(r[0],i[0],a[0],r[1],i[1],a[1],r[2],i[2],a[2])}}else if(a===`l`){let e=i.substring(1).trim().split(` `),n=[],r=[];if(i.indexOf(`/`)===-1)n=e;else for(let t=0,i=e.length;t<i;t++){let i=e[t].split(`/`);i[0]!==``&&n.push(i[0]),i[1]!==``&&r.push(i[1])}t.addLineGeometry(n,r)}else if(a===`p`){let e=i.slice(1).trim().split(` `);t.addPointGeometry(e)}else if((r=Gl.exec(i))!==null){let e=(` `+r[0].slice(1).trim()).slice(1);t.startObject(e)}else if(ql.test(i))t.object.startMaterial(i.substring(7).trim(),t.materialLibraries);else if(Kl.test(i))t.materialLibraries.push(i.substring(7).trim());else if(Jl.test(i))console.warn(`THREE.OBJLoader: Rendering identifier "usemap" not supported. Textures must be defined in MTL files.`);else if(a===`s`){if(r=i.split(` `),r.length>1){let e=r[1].trim().toLowerCase();t.object.smooth=e!==`0`&&e!==`off`}else t.object.smooth=!0;let e=t.object.currentMaterial();e&&(e.smooth=t.object.smooth)}else{if(i===`\0`)continue;console.warn(`THREE.OBJLoader: Unexpected line: "`+i+`"`)}}t.finalize();let i=new Cn;if(i.materialLibraries=[].concat(t.materialLibraries),!(t.objects.length===1&&t.objects[0].geometry.vertices.length===0))for(let e=0,n=t.objects.length;e<n;e++){let n=t.objects[e],r=n.geometry,a=n.materials,o=r.type===`Line`,s=r.type===`Points`,c=!1;if(r.vertices.length===0)continue;let l=new Tr;l.setAttribute(`position`,new pr(r.vertices,3)),r.normals.length>0&&l.setAttribute(`normal`,new pr(r.normals,3)),r.colors.length>0&&(c=!0,l.setAttribute(`color`,new pr(r.colors,3))),r.hasUVIndices===!0&&l.setAttribute(`uv`,new pr(r.uvs,2));let u=[];for(let e=0,n=a.length;e<n;e++){let n=a[e],r=n.name+`_`+n.smooth+`_`+c,i=t.materials[r];if(this.materials!==null){if(i=this.materials.create(n.name),o&&i&&!(i instanceof oi)){let e=new oi;Dr.prototype.copy.call(e,i),e.color.copy(i.color),i=e}else if(s&&i&&!(i instanceof yi)){let e=new yi({size:10,sizeAttenuation:!1});Dr.prototype.copy.call(e,i),e.color.copy(i.color),e.map=i.map,i=e}}i===void 0&&(i=o?new oi:s?new yi({size:1,sizeAttenuation:!1}):new Wi,i.name=n.name,i.flatShading=!n.smooth,i.vertexColors=c,t.materials[r]=i),u.push(i)}let d;if(u.length>1){for(let e=0,t=a.length;e<t;e++){let t=a[e];l.addGroup(t.groupStart,t.groupCount,e)}d=o?new vi(l,u):s?new wi(l,u):new Jr(l,u)}else d=o?new vi(l,u[0]):s?new wi(l,u[0]):new Jr(l,u[0]);d.name=n.name,i.add(d)}else if(t.vertices.length>0){let e=new yi({size:1,sizeAttenuation:!1}),n=new Tr;n.setAttribute(`position`,new pr(t.vertices,3)),t.colors.length>0&&t.colors[0]!==void 0&&(n.setAttribute(`color`,new pr(t.colors,3)),e.vertexColors=!0);let r=new wi(n,e);i.add(r)}return i}},iu=document.querySelector(`#viewport`),au=document.querySelector(`#asset-select`),ou=document.querySelector(`#obj-url`),su=document.querySelector(`#mtl-url`),cu=document.querySelector(`#z-up`),lu=document.querySelector(`#load-button`),uu=document.querySelector(`#reset-source`),du=document.querySelector(`#fit-button`),fu=document.querySelector(`#download-report`),pu=document.querySelector(`#render-state`),mu=document.querySelector(`#model-name`),hu=document.querySelector(`#webgl-fallback`),gu=document.querySelector(`#fallback-image`),_u=document.querySelector(`#fallback-message`),vu=document.querySelector(`#metrics`),yu=document.querySelector(`#checks`),bu=document.querySelector(`#summary-score`),xu=document.querySelector(`#exposure`),Su=document.querySelector(`#exposure-value`),Cu=document.querySelector(`#light-angle`),wu=document.querySelector(`#light-value`),Tu=document.querySelector(`#grid-toggle`),Eu=document.querySelector(`#axes-toggle`),Du=document.querySelector(`#shadow-toggle`),Ou=document.querySelector(`#rotate-toggle`),ku=[],Au=null,ju=null,Mu=null,Nu=`material`,Pu=!0,Fu=null,Iu=null,Lu=0,Ru=new Map,zu=new jn;zu.background=new X(1382937);var Bu=new ja(38,1,.01,1e4);Bu.position.set(8,6,8);var Vu=new Cn;zu.add(Vu);var Hu=new ya(14148830,2634030,1.35);zu.add(Hu);var Uu=new Pa(16777215,3.2);Uu.position.set(7,9,5),Uu.castShadow=!0,Uu.shadow.mapSize.set(2048,2048),Uu.shadow.bias=-15e-5,zu.add(Uu);var Wu=new Pa(10337711,1.25);Wu.position.set(-6,3,-5),zu.add(Wu);var Gu=new Pa(12113151,1.1);Gu.position.set(-3,7,8),zu.add(Gu);var Ku=new $a(20,20,6582636,3160374);Ku.material.transparent=!0,Ku.material.opacity=.44,zu.add(Ku);var qu=new eo(2.5);qu.visible=!1,zu.add(qu);var Ju=new Jr(new ji(200,200),new Mi({color:0,opacity:.22}));Ju.rotation.x=-Math.PI/2,Ju.receiveShadow=!0,Ju.position.y=-.002,zu.add(Ju);var Yu=new Ui({color:11450546,roughness:.52,metalness:0}),Xu=new Gi({side:2}),Zu=new Ki({depthPacking:Fe,side:2}),Qu=new Ir({color:12314837,wireframe:!0,side:2}),$u=new Vi({side:2,vertexShader:`
  ...
  `});function ed(e,t=document.baseURI){let n=e.trim();if(!n)return``;let r=n.match(/^https?:\/\/github\.com\/([^/]+)\/([^/]+)\/blob\/([^/]+)\/(.+)$/i);if(r){let[,e,t,n,i]=r;return`https://raw.githubusercontent.com/${e}/${t}/${n}/${i}`}return new URL(n,t).href}function td(e){return e.slice(0,e.lastIndexOf(`/`)+1)}function nd(e,t=`loading`){pu.textContent=e,pu.classList.toggle(`is-ready`,t===`ready`),pu.classList.toggle(`is-error`,t===`error`)}function rd(e){return new Intl.NumberFormat(`ru-RU`,{maximumFractionDigits:2}).format(e)}function id(e){let t=Array.isArray(e)?e:[e];for(let e of t){for(let t of Object.values(e))t instanceof Ht&&t.dispose();[Yu,Xu,Zu,Qu,$u].includes(e)||e.dispose()}}function ad(){ju&&(Vu.remove(ju),ju.traverse(e=>{if(!(e instanceof Jr))return;e.geometry.dispose();let t=Ru.get(e);t&&id(t)}),Ru.clear(),ju=null,Mu&&=(Vu.remove(Mu),Mu.geometry.dispose(),Mu.material.dispose(),null))}function od(e){Nu=e,document.querySelectorAll(`[data-mode]`).forEach(t=>t.classList.toggle(`is-active`,t.dataset.mode===e)),ju&&(ju.traverse(t=>{if(!(t instanceof Jr))return;let n=Ru.get(t);e===`material`&&n&&(t.material=n),e===`clay`&&(t.material=Yu),e===`normal`&&(t.material=Xu),e===`depth`&&(t.material=Zu),e===`orientation`&&(t.material=$u),e===`wireframe`&&(t.material=Qu)}),Mu&&(Mu.visible=e===`orientation`))}function sd(e){if(!ju||!Iu)return;document.querySelectorAll(`[data-view]`).forEach(t=>t.classList.toggle(`is-active`,t.dataset.view===e));let t=new Kn().setFromObject(ju).getBoundingSphere(new _r),n=Math.max(1,t.radius/Math.tan(Tt.degToRad(Bu.fov*.45))),r={perspective:new q(1,.72,1),front:new q(0,0,1),back:new q(0,0,-1),left:new q(-1,0,0),right:new q(1,0,0),top:new q(.001,1,.001)};Bu.position.copy(t.center).add(r[e].normalize().multiplyScalar(n*1.08)),Bu.near=Math.max(.001,n/500),Bu.far=n*20,Bu.updateProjectionMatrix(),Iu.target.copy(t.center),Iu.update()}function cd(){sd(`perspective`)}function ld(e,t){if(!e)return null;let n=Number(e);return!Number.isInteger(n)||n===0?NaN:n>0?n-1:t+n}function ud(e,t){let n=[],r=[],i=[],a=[],o=new Set,s=new Set,c=`default`,l=`default`,u=0,d=0,f=0;for(let t of e.split(/\r?\n/)){let e=t.trim();if(!e||e.startsWith(`#`))continue;let p=e.split(/\s+/);if(p[0]===`v`&&p.length>=4&&n.push([Number(p[1]),Number(p[2]),Number(p[3])]),p[0]===`vt`&&p.length>=3&&r.push([Number(p[1]),Number(p[2])]),p[0]===`vn`&&p.length>=4&&i.push([Number(p[1]),Number(p[2]),Number(p[3])]),(p[0]===`o`||p[0]===`g`)&&p[1]&&(c=p.slice(1).join(` `),o.add(c)),p[0]===`usemtl`&&p[1]&&(l=p.slice(1).join(` `),s.add(l)),p[0]!==`f`||p.length<4)continue;let m=p.slice(1).map(e=>{let[t,a,o]=e.split(`/`),s=ld(t,n.length),c=ld(a,r.length),l=ld(o,i.length);return(s===null||!Number.isFinite(s)||s<0||s>=n.length)&&(u+=1),c===null?d+=1:(!Number.isFinite(c)||c<0||c>=r.length)&&(u+=1),l===null?f+=1:(!Number.isFinite(l)||l<0||l>=i.length)&&(u+=1),{v:s,vt:c,vn:l}});a.push({object:c,material:l,corners:m})}let p=new Map,m=new Set,h=0,g=0,_=0,v=0,y=0;for(let e of a){let t=e.corners.map(e=>e.v).filter(e=>e!==null&&Number.isFinite(e));y+=e.corners.length;let r=`${e.object}|${[...t].sort((e,t)=>e-t).join(`,`)}`;m.has(r)&&(h+=1),m.add(r);for(let n=0;n<t.length;n+=1){let r=t[n],i=t[(n+1)%t.length],a=`${e.object}|${Math.min(r,i)}|${Math.max(r,i)}`,o=p.get(a)??{count:0,a:r,b:i};o.count+=1,p.set(a,o)}for(let r=1;r<t.length-1;r+=1){g+=1;let[a,o,s]=[n[t[0]],n[t[r]],n[t[r+1]]];if(!a||!o||!s)continue;let c=new q(o[0]-a[0],o[1]-a[1],o[2]-a[2]),l=new q(s[0]-a[0],s[1]-a[1],s[2]-a[2]),u=c.cross(l);if(u.lengthSq()<1e-16){_+=1;continue}let d=[e.corners[0],e.corners[r],e.corners[r+1]];if(d.every(e=>e.vn!==null&&Number.isFinite(e.vn)&&i[e.vn])){let e=d.reduce((e,t)=>e.add(new q(...i[t.vn])),new q);e.lengthSq()>1e-16&&u.dot(e)<0&&(v+=1)}}}let b=[],x=0,S=0;for(let e of p.values())e.count===1&&(x+=1),e.count>2&&(S+=1),e.count!==2&&n[e.a]&&n[e.b]&&b.push({kind:e.count===1?`open`:`non-manifold`,a:n[e.a],b:n[e.b]});let C=0;for(let e of i){let t=Math.hypot(...e);(!Number.isFinite(t)||Math.abs(t-1)>.002)&&(C+=1)}let w=new q(1/0,1/0,1/0),T=new q(-1/0,-1/0,-1/0);for(let e of n)w.min(new q(...e)),T.max(new q(...e));let E=T.clone().sub(w),D=[{id:`indices`,label:`Индексы OBJ`,detail:u?`${u} некорректных ссылок`:`все ссылки находятся в допустимых пределах`,status:u?`fail`:`pass`},{id:`manifold`,label:`Замкнутая топология`,detail:`${x} открытых · ${S} неманифолдных рёбер`,status:S?`fail`:x?`warn`:`pass`},{id:`degenerate`,label:`Площадь граней`,detail:`${_} вырожденных треугольников`,status:_?`fail`:`pass`},{id:`duplicates`,label:`Повторы граней`,detail:`${h} точных повторов`,status:h?`warn`:`pass`},{id:`normals`,label:`Пользовательские нормали`,detail:i.length?`${C} нормалей вне допуска`:`поток нормалей отсутствует`,status:!i.length||C?`warn`:`pass`},{id:`winding`,label:`Ориентация граней`,detail:v?`${v} треугольников расходятся с нормалями`:`порядок вершин согласован с нормалями`,status:v?`fail`:`pass`},{id:`uv`,label:`UV-развёртка`,detail:d?`${d} углов без UV`:`каждый угол грани имеет UV`,status:d?`warn`:`pass`},{id:`materials`,label:`Материальные слоты`,detail:`${s.size} материалов`,status:s.size?`pass`:`warn`}],O=D.reduce((e,t)=>e+(t.status===`fail`?18:t.status===`warn`?5:0),0),k=Math.max(0,Math.min(100,100-O));return{version:1,generatedAt:new Date().toISOString(),source:t,score:k,decision:D.some(e=>e.status===`fail`)?`stop`:D.some(e=>e.status===`warn`)?`inspect`:`continue`,metrics:{positions:n.length,textureCoordinates:r.length,normals:i.length,polygons:a.length,triangles:g,objects:o.size||1,materialSlots:s.size,openEdges:x,nonManifoldEdges:S,degenerateTriangles:_,invertedWindingTriangles:v,duplicateFaces:h,invalidIndices:u,missingUvCorners:d,missingNormalCorners:f,weldedPositionRatio:y?Math.max(0,1-n.length/y):0,bounds:{x:E.x,y:E.y,z:E.z}},checks:D,problemEdges:b.slice(0,1e4)}}function dd(e){let t=e.decision===`continue`?`структура прошла автоматические проверки`:e.decision===`inspect`?`нужен визуальный осмотр предупреждений`:`найдены блокирующие ошибки`;bu.innerHTML=`<strong>${e.score}/100</strong><span>${t}</span>`,vu.innerHTML=[[e.metrics.positions,`позиций`],[e.metrics.polygons,`полигонов`],[e.metrics.triangles,`треугольников`],[e.metrics.objects,`объектов`],[e.metrics.materialSlots,`материалов`],[`${rd(e.metrics.bounds.x)}×${rd(e.metrics.bounds.y)}×${rd(e.metrics.bounds.z)}`,`границы`]].map(([e,t])=>`<div class="metric"><strong>${typeof e==`number`?rd(e):e}</strong><span>${t}</span></div>`).join(``),yu.innerHTML=e.checks.map(e=>`<div class="check ${e.status===`pass`?``:e.status}"><strong>${e.label}</strong><span>${e.detail}</span></div>`).join(``),fu.disabled=!1}function fd(e){if(!e.problemEdges.length)return null;let t=[],n=[];for(let r of e.problemEdges){t.push(...r.a,...r.b);let e=r.kind===`open`?[1,.64,.12]:[1,.12,.08];n.push(...e,...e)}let r=new Tr;r.setAttribute(`position`,new pr(t,3)),r.setAttribute(`color`,new pr(n,3));let i=new vi(r,new oi({vertexColors:!0,depthTest:!1,transparent:!0,opacity:.96}));return i.renderOrder=20,i.visible=Nu===`orientation`,i}async function pd(e){let t=ed(e.obj),n=e.mtl?ed(e.mtl):``;if(!t)throw Error(`Укажите ссылку на OBJ`);nd(`Загрузка`,`loading`),mu.textContent=e.name??t.split(`/`).pop()??`OBJ`,gu.src=e.fallbackPreview?ed(e.fallbackPreview):``,ad();let r=await fetch(t,{mode:`cors`});if(!r.ok)throw Error(`OBJ не загружен: HTTP ${r.status}`);let i=await r.text(),a=ud(i,{obj:t,mtl:n||void 0});if(Au=a,dd(a),!Pu){hu.hidden=!1,_u.textContent=`Графический контекст недоступен. OBJ разобран, и автоматический отчёт сформирован без интерактивного рендера.`,nd(`Только отчёт`,`error`);return}let o=new ru;if(n){let e=await fetch(n,{mode:`cors`});if(!e.ok)throw Error(`MTL не загружен: HTTP ${e.status}`);let t=await e.text(),r=new Ul().parse(t,td(n));r.preload(),o.setMaterials(r)}let s=o.parse(i);s.rotation.x=e.zUp?-Math.PI/2:0,s.updateMatrixWorld(!0);let c=new Kn().setFromObject(s).getCenter(new q);s.position.sub(c),s.updateMatrixWorld(!0);let l=new Kn().setFromObject(s);s.position.y-=l.min.y,s.updateMatrixWorld(!0),s.traverse(e=>{e instanceof Jr&&(Ru.set(e,e.material),e.castShadow=!0,e.receiveShadow=!0,e.frustumCulled=!1)}),ju=s,Vu.add(s),Mu=fd(a),Mu&&s.add(Mu),od(Nu),cd(),nd(`Готово`,`ready`);let u=new URL(window.location.href);u.searchParams.set(`obj`,t),n?u.searchParams.set(`mtl`,n):u.searchParams.delete(`mtl`),u.searchParams.set(`up`,e.zUp?`z`:`y`),window.history.replaceState(null,``,u)}function md(){try{Fu=new bl({canvas:iu,antialias:!0,powerPreference:`high-performance`,preserveDrawingBuffer:!0}),Fu.outputColorSpace=Ie,Fu.toneMapping=4,Fu.toneMappingExposure=Number(xu.value),Fu.shadowMap.enabled=!0,Fu.shadowMap.type=2,Iu=new Al(Bu,iu),Iu.enableDamping=!0,Iu.dampingFactor=.08,Iu.screenSpacePanning=!0}catch(e){Pu=!1,hu.hidden=!1,_u.textContent=e instanceof Error?e.message:`Не удалось создать WebGL-контекст`,nd(`WebGL недоступен`,`error`)}}function hd(){if(!Fu)return;let e=iu.parentElement,t=Math.max(1,e.clientWidth),n=Math.max(1,e.clientHeight);Fu.setPixelRatio(Math.min(window.devicePixelRatio,1.75)),Fu.setSize(t,n,!1),Bu.aspect=t/n,Bu.updateProjectionMatrix()}function gd(){Lu=requestAnimationFrame(gd),!(!Fu||!Iu)&&(Ou.checked&&ju&&(ju.rotation.y+=.0035),Iu.update(),Fu.render(zu,Bu))}async function _d(){let e=await fetch(new URL(`models/registry.json`,document.baseURI));if(!e.ok)throw Error(`Не удалось загрузить реестр моделей`);ku=await e.json(),au.innerHTML=ku.map(e=>`<option value="${e.id}">${e.name}</option>`).join(``);let t=new URLSearchParams(window.location.search),n=t.get(`obj`);if(n){ou.value=n,su.value=t.get(`mtl`)??``,cu.checked=t.get(`up`)!==`y`,await pd({obj:n,mtl:su.value||void 0,zUp:cu.checked});return}let r=ku[0];if(!r)throw Error(`Реестр моделей пуст`);ou.value=ed(r.obj),su.value=r.mtl?ed(r.mtl):``,cu.checked=r.up!==`Y`,await pd({obj:r.obj,mtl:r.mtl,zUp:cu.checked,name:r.name,fallbackPreview:r.fallbackPreview})}document.querySelectorAll(`[data-mode]`).forEach(e=>e.addEventListener(`click`,()=>od(e.dataset.mode))),document.querySelectorAll(`[data-view]`).forEach(e=>e.addEventListener(`click`,()=>sd(e.dataset.view))),du.addEventListener(`click`,cd),lu.addEventListener(`click`,()=>pd({obj:ou.value,mtl:su.value||void 0,zUp:cu.checked}).catch(vd)),uu.addEventListener(`click`,()=>{let e=ku.find(e=>e.id===au.value)??ku[0];e&&(ou.value=ed(e.obj),su.value=e.mtl?ed(e.mtl):``,cu.checked=e.up!==`Y`)}),au.addEventListener(`change`,()=>{let e=ku.find(e=>e.id===au.value);e&&(ou.value=ed(e.obj),su.value=e.mtl?ed(e.mtl):``,cu.checked=e.up!==`Y`,pd({obj:e.obj,mtl:e.mtl,zUp:cu.checked,name:e.name,fallbackPreview:e.fallbackPreview}).catch(vd))}),fu.addEventListener(`click`,()=>{if(!Au)return;let e=new Blob([JSON.stringify(Au,null,2)],{type:`application/json`}),t=URL.createObjectURL(e),n=document.createElement(`a`);n.href=t,n.download=`${(mu.textContent??`model`).replace(/[^a-z0-9-_]+/gi,`-`).toLowerCase()}-qa-report.json`,n.click(),URL.revokeObjectURL(t)}),xu.addEventListener(`input`,()=>{Su.value=Number(xu.value).toFixed(2),Fu&&(Fu.toneMappingExposure=Number(xu.value))}),Cu.addEventListener(`input`,()=>{let e=Tt.degToRad(Number(Cu.value));Uu.position.set(Math.cos(e)*9,9,Math.sin(e)*9),wu.value=`${Cu.value}°`}),Tu.addEventListener(`change`,()=>{Ku.visible=Tu.checked}),Eu.addEventListener(`change`,()=>{qu.visible=Eu.checked}),Du.addEventListener(`change`,()=>{Fu&&(Fu.shadowMap.enabled=Du.checked),Ju.visible=Du.checked}),window.addEventListener(`resize`,hd),window.addEventListener(`beforeunload`,()=>cancelAnimationFrame(Lu));function vd(e){let t=e instanceof Error?e.message:String(e);nd(`Ошибка`,`error`),yu.innerHTML=`<div class="check bad"><strong>Загрузка</strong><span>${t}</span></div>`,_u.textContent=t,Pu||(hu.hidden=!1)}md(),hd(),gd(),_d().catch(vd);